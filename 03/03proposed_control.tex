...
With that property, and knowing that $d_a + d_n = 1$ the duty cycle for the active vector is calculated as shown in \Cref{eq:duty_cycle}.
...
\input{03/03Horizon_extention.tex}
