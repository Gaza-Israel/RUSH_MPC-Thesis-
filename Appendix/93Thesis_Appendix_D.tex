...
% \includepdf[pages={2-5},nup=1x4,landscape=false,scale=0.7,angle=90,pagecommand={\excerpt}]{./Appendix/Job3.pdf}
...
\subsubsection{Top Layer}
\begin{center}
	\includegraphics[page=10,width=0.47\textwidth,angle=90,origin=c]{./Appendix/Job1.pdf}
\end{center}
\subsubsection{Inner Layer 1}
\begin{center}
	\includegraphics[page=11,width=0.47\textwidth,angle=90,origin=c]{./Appendix/Job1.pdf}
\end{center}
\subsubsection{Inner Layer 2}
\begin{center}
	\includegraphics[page=12,width=0.47\textwidth,angle=90,origin=c]{./Appendix/Job1.pdf}
\end{center}
\subsubsection{Bottom Layer}
\begin{center}
	\includegraphics[page=13,width=0.47\textwidth,angle=90,origin=c]{./Appendix/Job1.pdf}
\end{center}
